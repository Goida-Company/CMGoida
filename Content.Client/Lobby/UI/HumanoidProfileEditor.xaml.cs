...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
            ...
            MarkingManager markings)
        {
            ...
            {
                ArmorPreferenceButton.AddItem(Loc.GetString($"humanoid-profile-editor-preference-armor-{value.ToString().ToLower()}"), (int)value); // RuСМ edit
            }
        ...
        private void RefreshVoiceTab()
        {
            ...
            {
                Logger.Debug("Asked for " + voiceId);
